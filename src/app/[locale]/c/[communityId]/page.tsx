    ...
    <div className="space-y-4">
      ...
      <div className="bg-card border rounded-lg overflow-hidden shadow-sm">
        <div className="relative h-48 w-full bg-muted">
          ...
          {/* Fading blur overlay */}
            <div
                className="absolute inset-x-0 bottom-0 h-3/4 bg-black/40 backdrop-blur-xl pointer-events-none"
                style={{
        ...
        <div className="p-4">
          <div className="relative flex items-center -mt-16">
            <Avatar className="h-20 w-20 md:h-24 md:w-24 border-4 border-card bg-muted shadow-md">
           ...
           <Card>
                ...
                <CardContent className="text-sm space-y-4">
                    ...
                    <div className="flex items-center gap-2 text-muted-foreground">
                        ...
                        <span>{t('created-on', { date: formatTimestamp(community.createdAt, { format: 'full', addSuffix: false }) })}</span>
                    </div>
                     <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <Card>
                 <CardHeader>
                    <CardTitle className="text-sm font-medium">{t('moderators-title')}</CardTitle>
                </CardHeader>
                 <CardContent>
