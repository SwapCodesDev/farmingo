...
export default function LocaleError({
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.error('Captured by top-level locale boundary:', error);
    }
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] w-full p-4 md:p-8 text-center bg-background">
      <motion.div
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto w-16 h-16 rounded-full bg-destructive/10 text-destructive flex items-center justify-center mb-6"
        >
