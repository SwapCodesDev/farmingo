...
export function EditCommunityDialog({ isOpen, onOpenChange, community }: EditCommunityDialogProps) {
  ...
  const handleImageUpload = (
    ...
    setCropState((prev) => ({ ...prev, aspect }));
    handleImageSelect(event, (cropped) => {
      form.setValue(field, cropped, { shouldDirty: true, shouldValidate: true });
    });
  };
             ...
             <FormField
                ...
                render={() => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input ref={iconInputRef} type="file" accept="image/*" className="hidden" onChange={(e) => handleImageUpload(e, 'iconUrl', 1)} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                )}
            ...
            <FormField
                ...
                render={() => (
                    <FormItem>
                        ...
                        <FormControl>
                            <Input ref={bannerInputRef} type="file" accept="image/*" className="hidden" onChange={(e) => handleImageUpload(e, 'bannerUrl', 4)} />
                        </FormControl>
