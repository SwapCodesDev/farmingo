  ...
  return (
    <div className="grid gap-8 lg:grid-cols-2">
      <Card className="flex flex-col">
        <CardHeader>
          <CardTitle className="font-headline">{t('upload')}</CardTitle>
          <CardDescription>
      ...
      <div className="flex items-center justify-center">
        ...
        {isLoading && !result && (
           ...
           <CardContent className="text-center p-6">
               ...
               <h3 className="mt-4 text-lg font-medium font-headline">{t('analyzing')}</h3>
               <p className="mt-1 text-sm text-muted-foreground">
        ...
        {result && (
          <Card className="w-full animate-in fade-in-50">
            ...
            <CardContent className="space-y-6">
                <div>
                <h4 className="font-headline font-semibold mb-2">{t('severity')}</h4>
                <p className="text-sm">{result.affectedSeverity}</p>
                </div>
              <div className="space-y-4">
                <div>
                  <h4 className="font-headline font-semibold mb-2 flex items-center gap-2 text-destructive">
                    <AlertCircle className="h-5 w-5" /> {t('immediate-steps')}
                  </h4>
                ...
                <div>
                  <h4 className="font-headline font-semibold mb-2 flex items-center gap-2 text-blue-600">
                    <CheckCircle2 className="h-5 w-5" /> {t('follow-up')}
                  </h4>
