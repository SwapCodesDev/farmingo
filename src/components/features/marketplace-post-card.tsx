  ...
  return (
    <>
      <div className="bg-card p-4 rounded-lg border hover:border-primary/50 transition-colors duration-200 flex flex-col sm:flex-row gap-4">
        <Link href={postUrl} className='w-full sm:w-48 lg:w-64 aspect-video sm:aspect-square relative block flex-shrink-0 mx-auto sm:mx-0 overflow-hidden rounded-md'>
            <Image src={post.imageUrl} alt={post.itemName} layout="fill" objectFit="cover" className="hover:scale-105 transition-transform duration-300" />
        </Link>
